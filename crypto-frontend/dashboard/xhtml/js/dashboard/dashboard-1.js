 ...
 var dzChartlist = function(){
	...
	var UiSlider = function() {
		try {
			...
			if (!employees1) {
				console.log('Employees1 slider element not found, skipping noUiSlider creation');
				return;
			}
			...
			console.log('Error creating employees1 slider:', error);
		}
	}
	var UiSlider1 = function() {
		try {
			...
			if (!employees) {
				console.log('Employees slider element not found, skipping noUiSlider creation');
				return;
			}
				var labels = { 1: '1', 10: '10', 15: '15', 20: '20', 25: '25', 40: '40', 50: '50', 70: '70', 75: '75', 100: '100', 100: '100', };
			...
			console.log('Error creating employees slider:', error);
		}
	}
